        ...
        @foreach($listroom as $item)
            ...
            <tr class="odd gradeX" align="center">
                ...
                <td>
                    ...
                    <a href="javascript:void(0)"><i data-type="bookroom" data-token="{!! csrf_token() !!}" data-id="{!! $item->id !!}"  class="fa fa-calendar calendar"  data-toggle="modal" data-target="#myModal"></i></a>
