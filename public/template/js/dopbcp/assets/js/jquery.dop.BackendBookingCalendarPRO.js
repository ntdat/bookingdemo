...
(function($){
    $.fn.DOPBackendBookingCalendarPRO = function(options){
        ...
        var Data = {'AddMonthViewText': 'Add month view',
                    ...
                    'loadURL': '../../../public/template/js/dopbcp/php-file/load.php',
                    'saveURL': '../../../public/template/js/dopbcp/php-file/save.php',
                    "form": {"data": {"style":5},
                             "text": {'submit': 'Submit',
                                      'reset': 'Reset'}},
...
// Schedule
        methods_schedule = {
             ...
             */    
                ...
                $.post(loadURL, {
                    dopbcp_calendar_id: ID,_token:token,
             ...
             */
                ...
                var namerurl = window.location.pathname;

                $.post(saveURL, {
                                 dopbcp_calendar_id: ID,
                                _token:token,
